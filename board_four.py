...
def io_init():
  ...
  wiringpi2.pinMode(16, wiringpi2.GPIO.OUTPUT)
  wiringpi2.pinMode(17, wiringpi2.GPIO.OUTPUT)
  wiringpi2.pinMode(26, wiringpi2.GPIO.OUTPUT)
  wiringpi2.pinMode(27, wiringpi2.GPIO.OUTPUT)
...
class Motors(object):
    ...
    def __init__(self):
        self.motor1 = Motor(12, 26, 16)
        self.motor2 = Motor(13, 27, 17)
